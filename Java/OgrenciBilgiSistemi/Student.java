...
public class Student {
	 String name,stuNo;
	    ...
	    public void calcAvarage() {
	    	this.fizik.note=(int) (this.fizik.note*0.8+this.fizik.sozluNotu*0.2);
	    	this.kimya.note=(int) (this.kimya.note*0.8+this.kimya.sozluNotu*0.2);
	    	this.mat.note=(int) (this.mat.note*0.8+this.mat.sozluNotu*0.2);
	    	this.avarage=(fizik.note+kimya.note+mat.note)/3;
	    }
